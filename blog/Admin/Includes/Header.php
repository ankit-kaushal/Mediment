...
<head>
    ...
    <title><?php echo (defined('TITLE')) ? TITLE . " &lsaquo;" : "" ?> Admin Panel || Seniors Hive</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="index.php">
                        ...
                        <!--This is dark logo icon--><img src="plugins/images/logo.png" alt="home" class="dark-logo" /><!--This is light logo icon--><img src="plugins/images/logo.png" width="30" alt="home" class="light-logo" />
                     </b>
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav slimscrollsidebar">
                ...
                <div class="center p-20">
                    <a href="https://seniorshive.com" target="_blank" class="btn btn-danger btn-block waves-effect waves-light">Mediment</a>
                </div>
            </div>
