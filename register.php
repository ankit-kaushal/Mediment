			...
			<div class="card">
				...
				<div class="card-body">
					<form method="post" id="patient_register_form">
						...
						<div class="row">
							<div class="col-md-6">
								<div class="form-group">
									...
									<input type="date" name="patient_date_of_birth" id="patient_date_of_birth" class="form-control" required  data-parsley-trigger="keyup" readonly />
								</div>
							</div>
							<div class="col-md-6">
								<div class="form-group">
						...
						<div class="form-group text-center">
							<p class="subtitle">Already have an account? <a href="login.php" style="color: rgb(66, 26, 201);">Login</a></p>
						</div>
					</form>
				</div>
			</div>
